...
class Status_Sentry_Sampling_Manager {
     ...
     */
    public function should_sample(string $feature, string $hook, float $sampling_rate): bool {
     ...
     */
    private function is_high_priority_event(string $feature, string $hook): bool {
     ...
     */
    private function adjust_sampling_rate(float $sampling_rate): float {
     ...
     */
    private function get_memory_limit_in_bytes(): int {
     ...
     */
    private function is_high_traffic(): bool {
